...
function part1(input) {
    ...
    for (const replacement of replacements) {
        ...
        do {
            ...
            if (startPos === -1) break
            const newMolecule = molecule.substring(0, startPos) + replacement[1] + molecule.substring(startPos + replacement[0].length)
    ...
    function go(molecule, iters) {
        ...
        for (const replacement of replacements) {
            ...
            do {
                ...
                if (startPos === -1) break
                const newMolecule = molecule.substring(0, startPos) + replacement[0] + molecule.substring(startPos + replacement[1].length)
